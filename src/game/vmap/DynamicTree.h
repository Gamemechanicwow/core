...
class DynamicMapTree
{
    public:
        ...
        bool getIntersectionTime(G3D::Ray const& ray, G3D::Vector3 const& endPos, float& maxDist, bool stopAtFirstHit = true) const;
        bool getObjectHitPos(G3D::Vector3 const& pPos1, G3D::Vector3 const& pPos2, G3D::Vector3& pResultHitPos, float pModifyDist, bool stopAtFirstHit = true) const;
